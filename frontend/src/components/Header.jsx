        ...
        <div className="navbar-wrapper">
          ...
          <div className="navbar-content h-[calc(100vh_-_74px)] py-2.5">
            ...
            <ul className="pc-navbar">
              ...
              <li className="pc-item"><a href="/addexpense" className="pc-link"><span className="pc-mtext">Add Expenses</span></a></li>
              <li className="pc-item"><a href="/addexpense" className="pc-link"><span className="pc-mtext">My Expenses</span></a></li>
            </ul>
          </div>
        </div>
      </nav>
      <header className="pc-header">
        <div className="header-wrapper flex max-sm:px-[15px] px-[25px] grow">{/* [Mobile Media Block] start */}
          ...
          <div className="ms-auto">
            <ul className="inline-flex *:min-h-header-height *:inline-flex *:items-center">
            <li>
            <div className="grid "><button className="btn btn-primary flex items-center justify-center"><svg className="pc-icon me-2 w-[22px] h-[22px]">
